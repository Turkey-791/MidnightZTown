...
-- Webhooks
-- [SECURITY FIX 2026-08-29] The webhook URL used to live here, but this file
-- is a shared_script (see fxmanifest.lua), meaning it is downloaded in full
-- to every connecting player's client. That is what exposed the old webhook
-- URL to players and led to the unauthorized Discord post on 2026-08-29.
-- The webhook is now defined in server/webhook_config.lua, which is loaded
-- as a server_script only and is never sent to clients. Set/replace the
-- webhook URL there, not here.
