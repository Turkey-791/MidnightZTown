...
Config.ClassSystem = true          -- 2026-09-03 BUG-02修正: true == restrict vehicles by class | false == any vehicle class in any garage
...
Config.OutVehicleSaveInterval = 120 -- 2026-09-03 BUG-04修正: 出庫中の自車のdamage/mods/fuelを何秒ごとに自動保存するか(秒)
