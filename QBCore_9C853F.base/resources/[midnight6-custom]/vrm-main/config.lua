...
Config.Range = {
    [1] = {r=205,g=248,b=249, a=30, size=1.5}, -- Eng:range normal [RGB + alpha + size of circle (dia)] | Hun:távolság normál  [RGB + alpha + kör mérete]
    [2] = {r=205,g=248,b=249,  a=60, size=3.0},  -- Eng:range whisper[RGB + alpha + size of circle (dia)] | Hun:távolság suttogás[RGB + alpha + kör mérete]
    [3] = {r=205,g=248,b=249,  a=100,size=6.0}  -- Eng:range shout  [RGB + alpha + size of circle (dia)] | Hun:távolság kiáltás [RGB + alpha + kör mérete]
}
